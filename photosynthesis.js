    ...
    container.innerHTML = `
        <div class="screen">
            ...
            <div class="story-text">
                ...
                <p>The only way to escape is to <strong>keep the light reactions running for 10 turns</strong> without letting any critical resource drop to zero. If the chloroplast collapses, they'll be stuck forever! Time is money, every decision should be made within 20 seconds, otherwise...</p>
                ...
                <p style="text-align: center; font-size: 1.1em; color: #dc2626; font-weight: bold; margin-top: 20px;">
                    ⏱️ You have 20 seconds per turn!
                </p>
            </div>
